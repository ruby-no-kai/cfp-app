class ApplicationController < ActionController::Base
  ...
  def after_sign_in_path_for(user)
    if session[:pending_invite_accept_url]
      ...
      edit_profile_path
    elsif request.referrer.present? && (request.referrer != new_user_session_url) && !request.referrer.start_with?(edit_password_url(current_user)) && (request.referrer != user_developer_omniauth_authorize_url)
      request.referrer
