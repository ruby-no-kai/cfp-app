class ApplicationController < ActionController::Base
  ...
  def after_sign_in_path_for(user)
    if session[:pending_invite_accept_url]
      ...
      edit_profile_path
    elsif (referer = request.referer).present? && (referer != new_user_session_url) && !referer.start_with?(edit_password_url(current_user)) && (referer != user_developer_omniauth_authorize_url) && (referer != 'https://github.com/')
      referer
